                        ...
                        <div class="card-body">
                            ...
                            @if($route->attractions->isNotEmpty())
                                <ul>
                                    ...
                                    @endphp <!-- Initialize total price variable -->
                                ...
                                @php
                                    ...
                                    session(['total_price' => $sessionTotalPrice]); // Store the updated total price in the session
                                @endphp
                            @else
                            ...
                            <div class="text-center">
                                <form action="{{ route('checkout') }}" method="POST">
                                    <button type="submit" name="_token" value="{{csrf_token()}}" class="btn" data-bs-toggle="modal" data-bs-target="#buy-ticket-modal" data-ticket-type="standard-access">Buy Now</button>
                                </form>
                            </div>
                        </div>
                    </div>
